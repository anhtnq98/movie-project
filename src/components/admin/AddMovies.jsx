...
export default function AddMovies() {
  ...
  const imagesListRef = ref(storage, "posters/movies/");
  const videosListRef = ref(storage, "videos/movies/");
  ...
  const uploadFile = (e) => {
    ...
    const imageRef = ref(storage, `posters/movies/${imageUpload.name}`);
  ...
  const uploadVideo = (e) => {
    ...
    const videoRef = ref(storage, `videos/movies/${videoUpload.name}`);
  ...
  const handleSubmit = (e) => {
    ...
    for (let i = 0; i < data.length; i++) {
      if (
        ...
        inputValue.video = videoUrls[videoUrls.length - 1];
        console.log(inputValue);
        axios.post("http://localhost:5000/movies", inputValue);
        setTimeout(() => {
  ...
  return (
    <div>
      <div className="body">
        ...
        >
          <Fade left>
            <div className="return-admin-movie">Về Trang Quản Lý Phim</div>
          </Fade>
        </NavLink>
        <Fade top>
          <div id="wrapper">
            <form onSubmit={handleSubmit} id="form-register">
              <h1 className="form-heading">THÊM PHIM LẺ</h1>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  type="text"
                  className="form-input"
                  placeholder="Thời lượng phim: ( VD : 148 phút )"
                  onChange={handleInputValue}
                />
              </div>
